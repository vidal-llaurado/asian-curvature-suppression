...
from asian_validation_common import ValidationConfig, run_european_control
...
def build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(description="Run European curvature control experiment.")
